...
<template>
    <div class="" v-if="carImages.length == 0">
        <svg class="w-42 h-42" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div v-else class="swiper-container">
        <swiper
            ...
            class="mySwiper"
        >
            <swiper-slide  v-for="image in carImages" :key="image.id">
               <img :src="'/storage/' + image.name" :alt="image.id">
            </swiper-slide>
        </swiper>
    </div>
</template>
