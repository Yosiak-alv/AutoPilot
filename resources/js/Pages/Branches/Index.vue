...
watch(form,debounce(() => {
    router.get('/branches', {search:form.search}, { preserveState:true , replace:true });
},500));
        ...
        <div class="py-12">
            <CardSection class="max-w-7xl">
                <div class="flex space-x-4 p-5">
                    ...
                    <div class="pt-2">
                        <PrimaryButton @click="createBranch()" >Agregar Centro</PrimaryButton>
                    </div>
                </div>
                        ...
                        <slot>
                            <tr v-for="branch in props.branches.data" :key="branch.id" class="hover:bg-gray-200 dark:hover:bg-gray-500  bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <Link :href="route('branches.show',{id: branch.id})">
