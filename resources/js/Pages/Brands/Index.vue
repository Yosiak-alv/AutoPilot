            ...
            <CardSection class="max-w-7xl">
                <div class="flex flex-wrap justify-between items-center p-5 ">
                    <div>
                        <div class="flex flex-wrap space-x-2 space-y-1">
                            <div class="relative ml-2 mt-1">
                                ...
                                <input type="search" v-model="search" class="block w-full p-2.5 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Buscar">
                            </div>
                            <div>
                                <Link 
                    ...
                    <div class="space-x-2 space-y-2">
                        <PrimaryButton class="ml-2 mt-1" v-if="hasPermission('crear marca')" @click="confirmBrandCreation()">Agregar Marca</PrimaryButton>
                    </div>
                </div>
